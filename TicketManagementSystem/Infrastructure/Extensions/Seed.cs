...
public static class Seed
{
    ...
    public static void GenerateSeed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IdentityRole>().HasData(
            new IdentityRole
            {
                Id = Constants.c_RoleAdminId,
                Name = Constants.c_RoleAdmin,
                NormalizedName = Constants.c_RoleAdmin.ToUpper()
            },
            new IdentityRole
            {
                Id = Constants.c_RoleUserId,
                Name = Constants.c_RoleUser,
                NormalizedName = Constants.c_RoleUser.ToUpper()
            });
        ...
        modelBuilder.Entity<IdentityUserRole<string>>().HasData(
            ...
            {
                RoleId = Constants.c_RoleAdminId,
                UserId = userId
            }
        );
